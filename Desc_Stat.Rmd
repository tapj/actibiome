...
p_age_category <- plot(age_category,'Patients Counts by Age Category', 'Age Category') + scale_x_discrete(limits=c("newborn","child","schoolage","adult","senior"))
...
figure <- ggarrange(ggarrange(p_disease,p_antibiotics_current_use, ncol = 2, widths = c(1,0.25),
                              #labels = c("Health","Antibiotic use")
                              labels = c("A","B")
                              ),
                    ggarrange(p_age_category, p_westernized, ncol = 2, widths = c(1,0.5),
